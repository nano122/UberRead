...
When contributing to `UberRead`, whether on GitHub or in other community spaces:

- Be respectful, civil, and open-minded.
- Before opening a new pull request, try searching through the [issue tracker](https://github.com/uberread/uberread/issues) for known issues or fixes.
...
In order to not waste your time implementing a change that has already been declined, or is generally not needed, start by [opening an issue](https://github.com/uberread/uberread/issues/new/choose) describing the problem you would like to solve.
...
This project is a monorepo. The code for the `uberread-app` is in the `apps/uberread-app` directory. Here are some useful scripts for developing the frontend only without compiling Tauri:
