...
**Why:** The project uses a local-git gstack install at `apps/uberread-app/.claude/skills/gstack`. Previous mistakes upgraded a global copy while the project's local copy stayed outdated.
