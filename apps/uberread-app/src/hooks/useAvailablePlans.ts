...
const IAP_PRODUCT_IDS = [
  'com.bilingify.uberread.monthly.plus',
  'com.bilingify.uberread.monthly.pro',
  'com.bilingify.uberread.storage.1gb.purchase',
  'com.bilingify.uberread.storage.2gb.purchase',
  'com.bilingify.uberread.storage.5gb.purchase',
  'com.bilingify.uberread.storage.10gb.purchase',
];
