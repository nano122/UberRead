...
const STORAGE_KEY_PREFIX = 'uberread_rsvp_wpm_';
const PUNCTUATION_PAUSE_KEY_PREFIX = 'uberread_rsvp_pause_';
const POSITION_KEY_PREFIX = 'uberread_rsvp_pos_';
const SPLIT_HYPHENS_KEY = 'uberread_rsvp_split_hyphens';
