...
export const DATA_SUBDIR = 'UberRead';
...
export const DOWNLOAD_UBERREAD_URL = 'https://uberread.com?utm_source=uberread_web';

export const UBERREAD_WEB_BASE_URL = 'https://web.uberread.com';
export const UBERREAD_NODE_BASE_URL = 'https://node.uberread.com';

export const SHARE_BASE_URL = `${UBERREAD_WEB_BASE_URL}/s`;
...
const LATEST_DOWNLOAD_BASE_URL = 'https://download.uberread.com/releases';

export const UBERREAD_UPDATER_FILE = `${LATEST_DOWNLOAD_BASE_URL}/latest.json`;

export const UBERREAD_CHANGELOG_FILE = `${LATEST_DOWNLOAD_BASE_URL}/release-notes.json`;

export const UBERREAD_PUBLIC_STORAGE_BASE_URL = 'https://storage.uberread.com';

export const UBERREAD_OPDS_USER_AGENT = 'UberRead/1.0 (OPDS Browser)';
