 ...
 * Converts between UberRead (foliate-js) CFI format and KOReader CREngine XPointer format
 */
...
export class XCFI {
  ...
  /**
   * Check if an element is injected by UberRead at runtime and should be
